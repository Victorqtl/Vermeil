...
-- CreateIndex
CREATE UNIQUE INDEX "UserFavorite_userId_articleId_key" ON "UserFavorite"("userId", "articleId");
...
-- AddForeignKey
ALTER TABLE "UserFavorite" ADD CONSTRAINT "UserFavorite_articleId_fkey" FOREIGN KEY ("articleId") REFERENCES "Article"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
