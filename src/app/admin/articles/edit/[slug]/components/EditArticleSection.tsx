...
import { UpdateArticleFormValues } from '@/lib/schemas/article.schema';
...
export default function EditArticleSection({
	...
	register: UseFormRegister<UpdateArticleFormValues>;
	errors: FieldErrors<UpdateArticleFormValues>;
	control: Control<UpdateArticleFormValues>;
}) {
